  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-lg text-gray-600">Volunteers who have participated in your events</p>
      </div>
      ...
      {volunteers && volunteers.length > 0 ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="mt-1 text-sm text-gray-500">Volunteers who register for your events will appear here.</p>
        </div>
      )}
    </div>
  );
